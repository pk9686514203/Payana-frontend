...
import { ArrowLeft, MapPin, Star, CheckCircle, Package } from "lucide-react";
          ...
          <div className="flex flex-col md:flex-row items-start gap-6">
            ...
            <div className="flex-1">
              <div className="flex items-center gap-2 mb-1">
                ...
                {agency.verified && (
                  <span className="flex items-center gap-1 bg-accent/10 text-accent px-2 py-0.5 rounded-md text-xs font-medium">
